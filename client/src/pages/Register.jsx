    ...
    <div style={{ minHeight: '100vh', background: '#ffecf1', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '20px' }}>
      <div style={{ background: '#fff', borderRadius: '20px', padding: '40px', width: '100%', maxWidth: '420px', border: '1px solid #f5c6d4' }}>
        ...
        <div style={{ textAlign: 'center', marginBottom: '28px' }}>
          ...
          <h1 style={{ fontSize: '22px', fontWeight: '700', color: '#222' }}>Create account</h1>
          <p style={{ fontSize: '14px', color: '#717171', marginTop: '4px' }}>Join StayPink today</p>
        </div>
        ...
        <form onSubmit={handleSubmit}>
          <div style={{ marginBottom: '16px' }}>
            <label style={{ fontSize: '13px', fontWeight: '600', color: '#222', display: 'block', marginBottom: '6px' }}>Full Name</label>
            <input
              type="text"
        ...
        <p style={{ textAlign: 'center', fontSize: '13px', color: '#717171', marginTop: '20px' }}>
          ...
          <Link to="/login" style={{ color: '#ff385c', fontWeight: '600', textDecoration: 'none' }}>Log in</Link>
        </p>
      </div>
    </div>
  );
